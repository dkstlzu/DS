...
public class AdjacencyListUndirectedGraph<T> : IGraph<T> 
{
    ...
    {
        ValidateVertexNumber(vertex1);
        ValidateVertexNumber(vertex2);

        return _vertexList[vertex1].ConnectionList.Contains(vertex2);
    }
    ...
    public List<int> GetNeighbors(int vertex)
    {
        ...
        return _vertexList[vertex].ConnectionList;
    }
    ...
    public void AddEdge(int vertexNumber1, int vertexNumber2)
    {
        ...
        if (_vertexList[vertexNumber1].IsAdjacentWith(vertexNumber2) || _vertexList[vertexNumber2].IsAdjacentWith(vertexNumber1))
        {
    ...
    class Enumerator : IEnumerator<T>
    {
        ...
        public Enumerator(AdjacencyListUndirectedGraph<T> graph)
        {
