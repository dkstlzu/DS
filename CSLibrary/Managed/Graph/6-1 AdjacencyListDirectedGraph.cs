...
class AdjacencyListVertex<T>
{
    public T? Value;
    public List<int> ConnectionList = new List<int>();

    public AdjacencyListVertex(T? t)
    {
        Value = t;
    }
    ...
    {
        ConnectionList.Remove(vertexNumber);
    }
...
public class AdjacencyListDirectedGraph<T> : IGraph<T>, IDirectedGraph<T>
{
    private List<AdjacencyListVertex<T>> _vertexList = new ();
    ...
    {
        _vertexList.Add(new AdjacencyListVertex<T>(t));
    ...
    {
        private List<AdjacencyListVertex<T>> _vertexList;
        private int _index;
        private T? _current;
        
        public Enumerator(AdjacencyListDirectedGraph<T> graph)
        {
