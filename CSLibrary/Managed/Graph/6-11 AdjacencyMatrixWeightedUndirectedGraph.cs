...
public class AdjacencyMatrixWeightedUndirectedGraph<T> : IWeightedGraph<T> 
{
    private List<T?> _vertexValues = new ();
    private List<List<bool>> _connected = new List<List<bool>>();
    private List<List<int>> _weight = new List<List<int>>();
    ...
    public int AddVertex(T? t)
    {
        ...
        foreach (var list in _weight)
        {
            list.Add(0);
        }

        var newVertexConnectionList = new List<bool>();
        var newVertexWeightList = new List<int>();

        for (int i = 0; i < _vertexValues.Count; i++)
        {
            newVertexConnectionList.Add(false);
            newVertexWeightList.Add(0);
        }
        
        _connected.Add(newVertexConnectionList);
        _weight.Add(newVertexWeightList);
    ...
    public void RemoveVertex(int vertexNumber)
    {
        ...
        _weight[vertexNumber] = _weight[^1];
    ...
    public int GetEdgeWeight(int vertexNumber1, int vertexNumber2)
    {
        ...
        return _weight[vertexNumber1][vertexNumber2];
    }
    ...
    public void SetEdgeWeight(int vertexNumber1, int vertexNumber2, int weight)
    {
        ...
        _weight[vertexNumber1][vertexNumber2] = weight;
        _weight[vertexNumber2][vertexNumber1] = weight;
    }
    ...
    class Enumerator : IEnumerator<T>
    {
        ...
        public Enumerator(AdjacencyMatrixWeightedUndirectedGraph<T> graph)
        {
