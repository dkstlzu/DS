...
public class LinearProbingHashTable<T> : IHashTable<T> where T : IEquatable<T>
{
    ...
    public LinearProbingHashTable() : this(DEFAULT_CAPACITY)
    {
        
    }
    
    public LinearProbingHashTable(int minimumCapacity)
    {
    ...
    {
        private LinearProbingHashTable<T> _hashTable;
        private int _index;
        private T? _current;
        
        public Enumerator(LinearProbingHashTable<T> hashTable)
        {
