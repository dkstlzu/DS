...
public class ResizableList<T> : IList<T> where T : IEquatable<T> 
{
    private T?[] _elements;
    private int _size;
    ...
    public void Resize(int newCapacity)
    {
        ...
        var newSize = Math.Min(_size, newCapacity);
    ...
    public void Insert(T? t, int index)
    {
        ...
        {
            Resize(Math.Max(index, _elements.Length * 2));
        }
    ...
    {
        private ResizableList<T> _list;
        private int _index;
        private int _size;
        private T? _current;
        
        public Enumerator(ResizableList<T> list)
        {
            _list = list;
            _size = list.Count();
        }
